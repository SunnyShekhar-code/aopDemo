...
public class LoggingAspect {
    ...
    public void logBeforeMethod() {
        System.out.println("controller Method Intercepted");
    }
    @Before("in.strikes.aopDemo.aspect.ApplicationPointCuts.serviceLayer()")
    public void logBeforeServiceMethod() {
        System.out.println("service Method Intercepted");
    }

    // @Before("in.strikes.aopDemo.aspect.ApplicationPointCuts.publicMethod()")
    // public void logBeforePublicMethod() {
    //     System.out.println("public Method Method Intercepted");
    // }

    @Before("in.strikes.aopDemo.aspect.ApplicationPointCuts.publicServiceMethod()")
    public void logBeforepublicServiceMethod() {
        System.out.println("public service Method Intercepted");
    }

    @Before("in.strikes.aopDemo.aspect.ApplicationPointCuts.serrviceGetterMethod()")
    public void logBeforegetterMethod() {
        System.out.println("service getter Method Intercepted");
    }
    ...
    // @Before("execution(* *.*(..)) &&
    // within(in.strikes.aopDemo.service.StudentService)")
    // public void logBeforeMethod(){
    // System.out.println("Method intercepetd");
    // }
    ...
    // in.strikes.aopDemo.service.StudentService.createStudent(in.strikes.aopDemo.dto.Student))")
    ...
    // class and different package and it's package using exection and withiin
    // deginator

    // deginator--> execution , within, annotation, bean

    // @Around(value="execution(*
    // in.strikes.aopDemo.service.StudentService.dummyMethod(..))")
